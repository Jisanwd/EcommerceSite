...
<head>
    ...
    <title>JisanEcommerceSite -@yield('title')</title>
                ...
                <div class="col-lg-4 col-md-4 col-12">
                    ...
                    @else
                        <div class="top-end">
                            <ul class="user-login">
                                <li>
                                    <a href="{{route('customer.auth')}}">Sign In</a>
                                </li>
                                <li>
                                    <a href="{{route('customer.auth')}}">Register</a>
                                </li>
                            </ul>
                        </div>
                    @endif
                            ...
                            <div class="cart-items">
                                ...
                                <div class="shopping-item">
                                    <div class="dropdown-cart-header">
                                        ...
                                        <a href="{{route('show')}}">View Cart</a>
                                    </div>
                                    <ul class="shopping-list">
                                        @foreach(Cart::getContent() as $cart_product)
                                        <li>
                                            <a href="{{route('cart.remove', ['id' => $cart_product->id])}}" class="remove" title="Remove this item"><i class="lni lni-close"></i></a>
                                            <div class="cart-img-head">
                                                <a class="cart-img" href="product-details.html"><img src="{{asset($cart_product->attributes->image)}}" alt="#"></a>
                                            </div>
                                            <div class="content">
                                                <h4><a href="product-details.html">
                                                        {{$cart_product->name}}</a></h4>
                                                <p class="quantity">1*{{$cart_product->quantity}} - <span class="amount">Tk.{{$cart_product->price}}</span></p>
                                            </div>
                                        </li>
                                        @endforeach
                        ...
                        <ul class="sub-category">
                            ...
                            <li><a href="{{route('category',['id' =>$category->id])}}">{{$category->name}}<i class="lni lni-chevron-right"></i></a>
                                <ul class="inner-sub-category">
                                    ...
                                    <li><a href="{{route('subCategory.add',['id' => $subCategory->id])}}">{{$subCategory->name}}</a></li>
                                    @endforeach
                                </ul>
                            </li>
                            @endforeach
